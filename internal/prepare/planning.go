...
func PlanningStep2Prompt(planContent, agentsContent, epicExamplePath, userPrompt string, effort epic.EffortLevel, mediaManifest, assetsSection string) string {
	userPromptLine := ""
	if userPrompt != "" {
