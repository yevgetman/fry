...
|---|---|---|
| 0.5 | Codebase context | `.fry/codebase.md` (if exists — generated by `fry init` on existing projects) |
| 0.75 | Codebase memories | `.fry/codebase-memories/*.md` (learnings from previous builds, 10KB cap) |
